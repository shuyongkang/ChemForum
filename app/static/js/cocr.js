// cocr.js a wrapper for cocr project
// import tfjs and smilesdrawer before using this file
const soso_classes = [
    '@', '-', '=', '#', '@@',
    'C', 'H', 'O', 'N', 'P', 'S',
];
...
async function postprocess(
    ...
    const result = await tf.image.nonMaxSuppressionWithScore(
...
// 从画布到零散的图元
async function predict(canvasSrc, modelUrl = '/static/js/model.json') {
    // 获取原图
